...
class StructureSection(BaseSection):
    ...
    def _build_entity(self, entity: Dict) -> str:
        ...
        sections = [
            ...
            self._build_questions_section(entity),
    ...
    def _build_questions_section(self, entity: Dict) -> Optional[str]:
        ...
        try:
            ...
            content = ["### Questions ouvertes"]
            content.append(f"*Liste des points à discuter.* ")
            if questions:
            ...
            logger.warning(f"Erreur section Questions ouvertes: {str(e)}")
...
```""")
    ...
    def _build_code_snippet(self, process: Dict) -> Optional[str]:
        ...
        if code:
            ...
            content.append(f"{self.MISSING_DATA_MESSAGE}\n")
